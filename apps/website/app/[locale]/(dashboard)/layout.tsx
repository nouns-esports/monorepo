  ...
  return (
    <div className="flex flex-col items-center w-full my-32 max-sm:my-24">
      <div className="w-full  flex gap-36 max-[1920px]:gap-16 max-2xl:gap-8 px-16 max-2xl:px-8 max-sm:px-4 max-w-[1920px]">
        <aside className="z-40 flex flex-col gap-4 w-60 h-full sticky top-32 flex-shrink-0 max-lg:hidden">
          <Sidebar />
        </aside>
        ...
        <aside className="z-40 flex flex-col gap-4 sticky h-full top-32 flex-shrink-0 max-[1350px]:hidden">
