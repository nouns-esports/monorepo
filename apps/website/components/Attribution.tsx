...
export default function Attribution(props: { small?: boolean }) {
  return (
    <div className="rounded-md w-full h-full flex drop-shadow-lg overflow-hidden bg-gradient-to-br from-[#F3B5FD] to-[#F66FD0] text-white font-semibold items-center gap-2">
      <img
