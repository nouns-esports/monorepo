...
async function downloadAll() {
  for (const proposal of proposals) {
    const images = [
      proposal.description.match(
        /https:\/\/ipfs.back end.prop.house\/ipfs\/[a-zA-Z0-9]*/g
      ) ?? [],
      proposal.description.match(
      ...
      proposal.description.match(
        /https:\/\/prop house.mypinata.cloud\/ipfs\/[a-zA-Z0-9]*/g
      ) ?? [],
    ];
  ...
  console.log("ipfs.back end.prop.house: ", ipfsBackend);
  console.log("lh7-us.googleusercontent.com: ", google7);
  console.log("lh5.googleusercontent.com: ", google5);
  console.log("propho use.mypinata.cloud: ", mypinata);
}
