...
await db.transaction(async (tx) => {
  ...
  await tx.insert(events).values({
    ...
    start: new Date("2024-10-07T05:00:00.000Z"),
    end: new Date("2024-10-13T05:00:00.000Z"),
    community: "nouns",
    featured: true,
    season: 1,
  } as unknown as any);
  await tx.insert(seasons).values({
    id: 1,
    start: new Date("2024-08-16T00:00:00.000Z"),
  ...
  await tx.insert(quests).values([
    {
      ...
      season: "1",
      event: "nounstown",
      createdAt: new Date("2024-10-07T05:00:00.000Z"),
      featured: false,
      active: true,
      start: null,
      end: null,
    ...
    },
    {
      ...
      featured: false,
      active: true,
      start: new Date("2024-10-09T19:00:00.000Z"),
      end: new Date("2024-11-09T01:00:00.000Z"),
      xp: 250,
      actions: ["visitLink"],
